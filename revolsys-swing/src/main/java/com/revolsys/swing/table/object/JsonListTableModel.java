...
public class JsonListTableModel extends AbstractTableModel
  ...
  private PropertyChangeArrayList<JsonObject> objects;

  public JsonListTableModel(final Collection<? extends JsonObject> objects,
  ...
  public JsonListTableModel(final List<String> columnNames, final List<String> columnTitles) {
    this(Collections.<JsonObject> emptyList(), columnNames, columnTitles);
  }

  public JsonListTableModel(final String... columnNames) {
    this(Collections.<JsonObject> emptyList(), Arrays.asList(columnNames), null);
    setEditable(false);
  }
  ...
  public void add(final JsonObject... objects) {
    addAll(Arrays.asList(objects));
  }

  public void addAll(final Collection<JsonObject> objects) {
  ...
  public Object getValueAt(final int rowIndex, final int columnIndex) {
    final var object = getObject(rowIndex);
    if (object == null) {
      return null;
    } else {
      try {
  ...
  public void reorder(final int fromIndex, int toIndex) {
    ...
    final JsonObject object = getObject(fromIndex);
    removeAll(object);
    add(toIndex, object);
  }
