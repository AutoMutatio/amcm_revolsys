...
public class SpringSwingMain implements UncaughtExceptionHandler {
  ...
  /**
   * Override to perform any non Swing tasks after the Look and Feel has been
   * initialized,
  ...
  /**
   * Override to setup the swing components, don't use
   * {@link Component#setVisible(boolean)} instead use
   * {@link SwingUtil#showAsync(java.awt.Component)}.
   */
  ...
  /**
   * Override to initialize anything that needs to be setup before the Swing
   * Thread starts
   */
