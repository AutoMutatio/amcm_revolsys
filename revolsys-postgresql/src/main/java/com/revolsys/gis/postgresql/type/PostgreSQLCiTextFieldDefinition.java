...
public class PostgreSQLCiTextFieldDefinition extends JdbcFieldDefinition {

  public PostgreSQLCiTextFieldDefinition(final String dbName, final String name, final int sqlType,
  ...
  public JdbcFieldDefinition clone() {
    final PostgreSQLCiTextFieldDefinition clone = new PostgreSQLCiTextFieldDefinition(getDbName(),
