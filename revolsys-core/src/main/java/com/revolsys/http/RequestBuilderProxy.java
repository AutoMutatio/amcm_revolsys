...
public interface RequestBuilderProxy {
  default RequestBuilderProxy addHeader(final Header header) {
    getRequestBuilder().addHeader(header);
    return this;
  }

  default RequestBuilderProxy addHeader(final String name, final String value) {
    getRequestBuilder().addHeader(name, value);
    return this;
  }

  default RequestBuilderProxy addParameter(final NameValuePair nvp) {
    getRequestBuilder().addParameter(nvp);
    return this;
  }

  default RequestBuilderProxy addParameter(final String name, final Object value) {
    getRequestBuilder().addParameter(name, value);
    return this;
  }

  default RequestBuilderProxy addParameters(final NameValuePair... nvps) {
  ...
  default RequestBuilderProxy removeHeader(final Header header) {
    getRequestBuilder().removeHeader(header);
    return this;
  }

  default RequestBuilderProxy removeHeaders(final String name) {
    getRequestBuilder().removeHeaders(name);
    return this;
  }

  default RequestBuilderProxy setConfig(final RequestConfig config) {
    getRequestBuilder().setConfig(config);
    return this;
  }

  default RequestBuilderProxy setEntity(final HttpEntity entity) {
    getRequestBuilder().setEntity(entity);
    return this;
  }

  default RequestBuilderProxy setParameter(final NameValuePair nvp) {
    getRequestBuilder().setParameter(nvp);
    return this;
  }

  default RequestBuilderProxy setParameter(final String name, final Object value) {
