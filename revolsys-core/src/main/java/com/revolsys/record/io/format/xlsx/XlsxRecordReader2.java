...
public class XlsxRecordReader2 extends AbstractRecordReader {
  ...
  private boolean wasTempFile;

  private OPCPackage opcPackage;

  public XlsxRecordReader2(final Resource resource) {
  ...
  protected void initDo() {
    ...
    final var file = this.resource.getOrDownloadFile();
    try {
      this.wasTempFile = this.resource.isFile();
