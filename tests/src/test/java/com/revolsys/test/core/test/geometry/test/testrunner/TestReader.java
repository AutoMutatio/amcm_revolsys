 ...
 */
package com.revolsys.test.core.test.geometry.test.testrunner;

import java.io.File;

import com.revolsys.geometry.model.Geometry;
import com.revolsys.geometry.model.GeometryFactory;
import com.revolsys.test.core.test.geometry.test.function.GeometryFunctionRegistry;
import com.revolsys.test.core.test.geometry.test.function.TestCaseGeometryFunctions;
import com.revolsys.test.core.test.geometry.test.geomop.GeometryFunctionOperation;
import com.revolsys.test.core.test.geometry.test.geomop.GeometryOperation;
import com.revolsys.test.core.test.geometry.test.util.WKTOrWKBReader;
...
public class TestReader {
  ...
  private final GeometryOperation geomOp = GEOMETRY_FUNCTION_OPERATION;

  private final ResultMatcher resultMatcher = EQUALITY_RESULT_MATCHER;
  ...
  // private double newPrecisionModel(final Element precisionModelElement)
  // throws TestParseException {
  // final Attribute scaleAttribute =
  // precisionModelElement.getAttribute("scale");
  // if (scaleAttribute == null) {
  // throw new TestParseException("Missing scale attribute in
  // <precisionModel>");
  // }
  // double scale;
  // try {
  ...
  // public TestFile newTestRun(final TestDirectory parent, final File testFile,
  // final int runIndex)
  // throws Throwable {
  // try {
  // final var builder = new LineNumberSAXBuilder();
  // final var document = builder.build(new FileInputStream(testFile));
  // final var runElement = document.getRootElement();
  ...
  // * @throws TestParseException
  // */
  // private double parsePrecisionModel(final Element runElement) throws
  // TestParseException {
  // final Element precisionModelElement =
  // runElement.getChild("precisionModel");
  ...
  // if (scaleAttribute != null
  // || typeAttribute != null &&
  // typeAttribute.getValue().strip().equalsIgnoreCase("FIXED")) {
  // if (typeAttribute != null &&
  // typeAttribute.getValue().strip().equalsIgnoreCase("FLOATING")) {
  ...
  // * @throws TestParseException if a parsing error was encountered
  // */
  // private ResultMatcher parseResultMatcher(final Element runElement) throws
  // TestParseException {
  ...
  // */
  // private List<TestCase> parseTestCases(final List caseElements, final File
  // testFile,
  ...
  // : "";
  // final Geometry a = readGeometry(aElement, absoluteWktFile(aWktFile,
  // testRun));
  // final Geometry b = readGeometry(bElement, absoluteWktFile(bWktFile,
  // testRun));
  // final TestCase testCase = new TestCase(description, a, b, aWktFile,
  // bWktFile, testRun,
  ...
  // * @param parent
  // */
  // private TestFile parseTestRun(final TestDirectory parent, final Element
  // runElement,
  ...
  // }
  // workspace = new
  // File(runElement.getChild("workspace").getAttribute("dir").getValue().strip());
  // if (!workspace.exists()) {
  ...
  // if (arg3 == null &&
  // nameAttribute.getValue().strip().equalsIgnoreCase("relate")) {
  ...
  // tests.add(test);
  // } catch (final Exception e) {
  // throw new IllegalArgumentException("An exception occurred while parsing
  // <test> " + testIndex
  ...
  // }
  //
  // private double parseTolerance(final Element runElement) throws
  // TestParseException {
  // double tolerance = 0.0;
  // // Note: the tolerance element applies to the coordinate-by-coordinate
  // // comparisons of spatial functions. It does not apply to binary
  // predicates.
  // // [Jon Aquino]
  ...
  // throw new TestParseException(
  // "Could not parse tolerance from string: " +
  ...
  // private Geometry readGeometry(final Element geometryElement, final File
  // wktFile)
  // throws FileNotFoundException, com.revolsys.geometry.wkb.ParseException,
  // IOException {
  ...
  // private BooleanResult toBooleanResult(final String value) throws
  // TestParseException {
  ...
  // } else {
  // throw new TestParseException("Expected 'true' or 'false' but encountered '"
  // + value + "'");
  // }
  // }
  //
  // private DoubleResult toDoubleResult(final String value) throws
  // TestParseException {
  // try {
  ...
  // private GeometryResult toGeometryResult(final String value, final TestFile
  // testRun)
  ...
  // }
  //
  // private IntegerResult toIntegerResult(final String value) throws
  // TestParseException {
  // try {
  ...
  // }
  //
  // private Result toResult(final String value, final String name, final
  // TestFile testRun)
  ...
  // throws TestParseException {
  // if (geometryElement == null || geometryElement.getAttribute("file") ==
  // null) {
  // return null;
  // }
  // if (!geometryElement.getTextTrim().equals("")) {
  // throw new TestParseException("WKT specified both in-line and in external
  // file");
  // }
  //
  // final File wktFile = new
  // File(geometryElement.getAttribute("file").getValue().strip());
