 ...
 */
package com.revolsys.test.core.test.geometry.test.geomop;

import com.revolsys.geometry.model.Geometry;
import com.revolsys.test.core.test.geometry.test.function.GeometryFunction;
import com.revolsys.test.core.test.geometry.test.function.GeometryFunctionRegistry;
import com.revolsys.test.core.test.geometry.test.testrunner.BooleanResult;
import com.revolsys.test.core.test.geometry.test.testrunner.DoubleResult;
import com.revolsys.test.core.test.geometry.test.testrunner.GeometryResult;
import com.revolsys.test.core.test.geometry.test.testrunner.IntegerResult;
import com.revolsys.test.core.test.geometry.test.testrunner.JTSTestReflectionException;
import com.revolsys.test.core.test.geometry.test.testrunner.Result;
